...
const store = () => {
  router.post(route('inquiries.store'), form)
}
        ...
        <div class="bg-white border border-gray-200 rounded-lg p-6">
          ...
          <form @submit.prevent="store" class="space-y-5">
            ...
            <div class="flex justify-end gap-3 pt-4 border-t">
              <Link :href="route('inquiries.index')" class="px-4 py-2 text-sm text-gray-600 border border-gray-300 rounded-md hover:bg-gray-50">
                キャンセル
              </Link>
