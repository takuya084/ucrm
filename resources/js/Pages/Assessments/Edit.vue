        ...
        <div class="bg-white shadow-sm rounded-lg p-6">
          ...
          <form @submit.prevent="update" class="space-y-6">
            ...
            <div class="flex justify-end gap-3 pt-4 border-t">
              <Link :href="route('children.assessments.show', [child.id, assessment.id])" class="px-4 py-2 text-sm text-gray-600 border border-gray-300 rounded hover:bg-gray-50">
                キャンセル
              </Link>
