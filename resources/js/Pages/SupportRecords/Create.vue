    ...
    <div class="py-8">
      <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white border border-gray-200 rounded-lg p-6">
          ...
          <div v-if="child.care_note" class="mb-5 p-3 bg-amber-50 border border-amber-200 rounded-md text-sm">
            <span class="font-medium text-amber-700">⚠ 配慮事項：</span>
            <span class="text-amber-800">{{ child.care_note }}</span>
          </div>
                    ...
                    >
                      ...
                      <div class="flex flex-wrap gap-2">
                        ...
                        >
                          ...
                          />
                          <span class="text-primary-300 text-xs">{{ item.difficulty_order }}</span>
                          {{ item.name }}
                        </label>
                      </div>
                    </div>
