...
class LoginRequest extends FormRequest
{
    ...
    /**
     * 資格情報を検証し、2FA 有効ユーザーの場合はログインせずにユーザーを返す。
     * （このあと 2FA チャレンジ画面でコード検証後に Auth::login する）
     * 2FA 未設定ユーザーは従来どおりログインまで行い null を返す。
     *
     * @throws \Illuminate\Validation\ValidationException
     */
    public function authenticateOrGetTwoFactorUser(): ?\App\Models\User
    {
        $this->ensureIsNotRateLimited();
